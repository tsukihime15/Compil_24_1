...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_decl_global = 43,               /* decl_global  */
  YYSYMBOL_44_1 = 44,                      /* $@1  */
  YYSYMBOL_id_global = 45,                 /* id_global  */
...
{
       0,   112,   112,   117,   122,   133,   136,   144,   144,   146,
     154,   171,   172,   173
};
#endif
...
static const char *const yytname[] =
{
  ...
  "element", "decl_global", "$@1", "id_global", "type", YY_NULLPTR
};
...
{
      -3,   -30,   -30,   -30,     3,   -30,    -3,   -30,   -30,   -30,
     -30,   -12,   -29,   -28,   -12,   -30,   -30
};
...
{
       1,     2,     3,     9,    12,    14,    15,    10,    16
};

static const yytype_int8 yycheck[] =
{
       3,     4,     5,     0,    16,    34,    34,     6,    14
};
...
{
       0,     3,     4,     5,    40,    41,    42,    43,    46,     0,
      41,    44,    16,    45,    34,    34,    45
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    39,    40,    40,    41,    41,    42,    44,    43,    45,
      45,    46,    46,    46
};
...
#line 112 "parser.y"
     ...
     (yyval.nodo) = (yyvsp[0].nodo); arvore = (yyval.nodo);
          imprimeInstrucoesNodo((yyval.nodo));
...
#line 1405 "parser.tab.c"
  ...
  case 4: /* program_list: element program_list  */
#line 122 "parser.y"
...
#line 1421 "parser.tab.c"
  ...
  case 5: /* program_list: element  */
#line 133 "parser.y"
                          {(yyval.nodo)=(yyvsp[0].nodo);}
#line 1427 "parser.tab.c"
    break;

  case 6: /* element: decl_global  */
#line 136 "parser.y"
                      { // Declaracoes nao sao usadas nessa etapa

        | func {(yyval.nodo) = (yyvsp[0].nodo);}
}
#line 1436 "parser.tab.c"
  ...
  case 7: /* $@1: %empty  */
#line 144 "parser.y"
                  { tipo_atual = verificaTipo((yyvsp[0].nodo)->valor_token); }
#line 1442 "parser.tab.c"
    break;

  case 9: /* id_global: TK_IDENTIFICADOR ',' id_global  */
#line 147 "parser.y"
{ 
	(yyvsp[-2].valor_lexico)->tipo_token = tipo_atual; 
	(yyvsp[-2].valor_lexico)->tamanho_token = infereTamanho(tipo_atual); 
	verificaERR_DECLARED(lista_tabelas,(yyvsp[-2].valor_lexico)); 
	insereUltimaTabela(&lista_tabelas, (yyvsp[-2].valor_lexico)); 
}
#line 1453 "parser.tab.c"
    break;

  case 10: /* id_global: TK_IDENTIFICADOR  */
#line 155 "parser.y"
{ 
	(yyvsp[0].valor_lexico)->tipo_token = tipo_atual; 
	(yyvsp[0].valor_lexico)->tamanho_token = infereTamanho(tipo_atual); 
	verificaERR_DECLARED(lista_tabelas,(yyvsp[0].valor_lexico)); 
	insereUltimaTabela(&lista_tabelas, (yyvsp[0].valor_lexico));
}
